...
Also concluded chapter 0 of Sipser Computer Theory. Didn't complete really well all the exercices, but I think that all the important ones are made.

- **23/06:** Spent most part of my day (12 hours) in company tshirt estimating 7 features (or part of it) that we'll develop in the next 3 Sprints. I really liked the way my team helped by splitting the topics and break down the items. Fernando spent the day working in the release.
  I didn't exercise though, arrive really mentally tired. Still wanted to do something that matters, so this microblog.
